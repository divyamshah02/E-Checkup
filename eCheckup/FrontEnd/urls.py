...
router.register(r'all_cases', AllCasesViewSet, basename='all_cases')
router.register(r'reports', ReportsViewSet, basename='reports')
router.register(r'insurance-finance', licFinanceViewSet, basename='insurance-finance')
...
router.register(r'insurance-management', LICManagementViewSet, basename='insurance-management')
